...
Student Name: Tuba Gulfen Qureshi
Roll Number: 24BAI10796
...
git clone (https://github.com/Tuba1809/oss-audit-project.git)
...
sudo ./scripts/kernel_log_analyzer.sh error sudo ./scripts/kernel_log_analyzer.sh warning
